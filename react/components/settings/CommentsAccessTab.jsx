...
import { updateAccess } from './../../actions/setting-actions'
...
export default class CommentsAccessTab extends React.Component {
    ...
    edit = (row, e) => {
        this.props.dispatch(updateAccess(row.ID, e.target.checked));
    };
