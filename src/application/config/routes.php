...
$route['login'] = 'authentication/login_test'; // login with SMS
$route['login_test'] = 'authentication/login_test'; // login with SMS
$route['login_sms'] = 'authentication/login_sms'; // login with SMS
...
$route['documents/(:num)'] = 'Documents/index';
$route['documents/(:num)/upload'] = 'Documents/upload/$1';
$route['documents/(:num)/server'] = 'Documents/server/$1';
$route['documents/(:num)/add/file']      = 'Documents/add/$1';
$route['documents/(:num)/edit/(:num)']   = 'Documents/edit/$1/$2';
$route['documents/(:num)/show/(:num)']   = 'Documents/show/$1/$2';
...
$route['training/(:num)/upload']        = 'Training/upload/$1';
$route['training/(:num)/server']        = 'Training/server/$1';
