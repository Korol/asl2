...
class MY_Model extends CI_Model {
    ...
    const TABLE_CUSTOMER_PHOTO_NAME = 'assol_customer_photo';
    ...
    const TABLE_DOCUMENT_ARTICLE_NAME = 'assol_document_article';
    const TABLE_DOCUMENT_ARTICLE_RIGHTS_NAME = 'assol_document_article_rights';
    ...
    const TABLE_SERVICE_CONTACT_NAME = 'assol_service_contact';
    ...
    const TABLE_EMPLOYEES_SERVICES_ACCESS = 'assol_employees_services_access';
    const TABLE_CALLS = 'assol_calls';
