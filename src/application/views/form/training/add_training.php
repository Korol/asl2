...
<div class="add-training-article-page">
<p><b>СОЗДАТЬ СТАТЬЮ</b></p>
<br>

<div class="form-group">
    <label for="TrainingName">Название статьи:</label>
    <input id="TrainingName" type="text" class="assol-input-style fullwidth defaultheight" placeholder="Название статьи">
</div>

<div class="form-group">
    <label for="TrainingContent">Текст статьи:</label>
    <textarea id="TrainingContent" class="tinymce-editor"></textarea>
</div>
