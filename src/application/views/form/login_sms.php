...
<div class="container">
	...
	<form class="form-signin" method="post" action="<?=base_url('login_sms'); ?>" style="float: none">
		...
		<div class="form-group">
			<input type="text" class="form-control" id="inSmsCode" name="sms_code" placeholder="Код из СМС" required="true">
		</div>
