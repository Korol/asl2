            ...
            <div role="tabpanel" class="tab-pane" id="Work">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-group">
                            <label for="JobComment">Примечание</label>
                            <input type="text" class="assol-input-style" id="JobComment" placeholder="Примечание" value="<?=(!empty($employee['JobComment'])) ? $employee['JobComment'] : ''; ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <? foreach($employees as $item): ?>
                                            <li>
                                                ...
                                                <label for="employeeAccess_<?= $item['ID'] ?>">
                                                    <?= $item['SName'] ?> <?= $item['FName'] ?>
                                                    <span class="orange text-lowercase"><?= $roles_arr[$item['UserRole']]; ?></span>
                                                    <span class="orange"><?= $item['JobComment']; ?></span>
                                                </label>
                                            </li>
                                        <? endforeach ?>
                                    </ul>
