<div class="modal-header">
    ...
    <h4 class="modal-title" id="remoteDialogLabel">Редактировать папку</h4>
</div>
<div class="modal-body">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="Name" placeholder="Название папки" value="<?= $record['Name'] ?>">
    </div>
        ...
        <div class="btn-group assol-select-dropdown" id="Parent">
            ...
            <ul class="dropdown-menu">
                ...
                <li>
                    ...
                    <label for="Parent_0">Без категорий</label>
                </li>
    ...
    <div class="checkbox-line">
        <label>
            <input id="IsSub" type="checkbox">
            <mark></mark>
            <span><strong>К вложенным</strong></span>
        </label>
    </div>
...
<div class="modal-footer">
    <div class="form-group">
        <button type="button" class="btn assol-btn save form-control" id="bSubmit">Сохранить</button>
    </div>
</div>
...
<script>
    ...
    function callback(data) {
        if (data.status) {
            ...
            $.AssolDocument.SetParent($('#Parent').find("input:radio:checked").val());
