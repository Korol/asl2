$(document).ready(function(){
    ...
    $.AssolTraining = {
        ...
        InitActions: function() {
            ...
            // file
            $(document).on("click", ".action-file-remove", function (e) {
                confirmRemove(function(){
                    $.AssolTraining.RemoveFile($(e.target).closest('[record]').attr('record'));
                });
            });
        },
        ...
        RemoveFile: function (id) {
            ...
            $.post(BaseUrl + 'training/delete_file/' + id, {id: id}, callback, 'json');
        },
