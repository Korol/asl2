$(document).ready(function(){
    ...
    $.AssolDocument = {
        ...
        InitActions: function() {
            ...
            /** Articles */
            $(document).on("click", ".action-article-add", function () {
                window.location.href = BaseUrl + 'documents/' + $.AssolDocument.GetParent() + '/add/file';
            });

            $(document).on("click", ".action-article-remove", function (e) {
                confirmRemove(function(){
                    $.AssolDocument.RemoveArticle($(e.target).closest('[record]').attr('record'));
                });
            });
        },
        ...
        RemoveArticle: function (id) {
            ...
            $.post(BaseUrl + 'documents/remove_article', {id: id}, callback, 'json');
        },
